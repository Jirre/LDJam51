...
namespace Project.Input
{
    public class CameraController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            bool lKey = UnityEngine.Input.GetKey(KeyCode.A) || mousePos.x < _BorderWidth.x;
            bool rKey = UnityEngine.Input.GetKey(KeyCode.D) || mousePos.x > 1f - _BorderWidth.x;
            
            bool uKey = UnityEngine.Input.GetKey(KeyCode.W) || mousePos.y > 1f - _BorderWidth.y;
            bool dKey = UnityEngine.Input.GetKey(KeyCode.S) || mousePos.y < _BorderWidth.y;
